package com.example.voidapplication.Adapter;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.RecyclerViewHolder> {
    ...
    public void onBindViewHolder(RecyclerAdapter.RecyclerViewHolder holder, int position) {
        ...
        holder.nameTextView.setText(currentCollection.getName());
        holder.descriptionTextView .setText(currentCollection.getDescription());
        holder.dateTextView.setText(getDateToday());
        Picasso.get()
                .load(currentCollection.getImageUrl())
